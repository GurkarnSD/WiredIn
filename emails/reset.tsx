...
export default function ResetTemplate(params: { token: string, siteURL: string, user: string }) {
    ...
    return (
        <Html style={mainStyle}>
            ...
            <Section style={body}>
                <Text style={textHeader}>Reset Your Password</Text>
                <Text style={bodyGreeting}>Hi {user},</Text>
                <Text style={bodyText}>
                    <Link href={`${siteURL}/resetpassword/${token}`}>Click Here</Link>
