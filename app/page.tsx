  ...
  return (
    <div className={styles.home}>
      <div className={styles.mainBar}>
        <Link href={user ? '/feed' : '/'} aria-label='Home'>
        ...
        <div className={styles.navigation}>
          {user &&
            <div className={styles.links}>
              <Link className={styles.link} href="/feed" aria-label='Feed'>
                Feed
              </Link>
              <Link className={styles.link} href="/contracts" aria-label='Contracts'>
                Contracts
              </Link>
              <Link className={styles.link} href="/jobs" aria-label='Jobs'>
                Jobs
              </Link>
            </div>
          }
          {user ? <NavbarDropdown session={session} lightMode={true} /> : <div className={styles.headerButtons}><Link className={styles.signupButton} href='/signup' aria-label='Signup'>Sign Up</Link><Link className={styles.loginButton} href='/login' aria-label='Login'>Log In</Link></div>}
        </div>
      </div>
      <div className={styles.mainSection}>
        <div className={styles.mainHeader}>
          ...
          <div className={styles.mainButtons}>
            <LearnMoreButton />
            <Link className={styles.mainButton} href='/signup' aria-label='Signup'>
              Get Started
            </Link>
          </div>
        </div>
