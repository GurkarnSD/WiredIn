    ...
    <div className={styles.home}>
      <div className={styles.mainBar}>
        ...
        <div className={styles.barButtons}>
          <Link className={styles.barButton} href='/signup'>Sign Up</Link>
          {user ? <NavbarDropdown user={user} lightMode={true} /> : <Link className={styles.barButton} href='/login'>Login</Link>}
        </div>
      </div>
      <div className={styles.mainSection}>
        <div className={styles.mainHeader}>
          <h1 className={styles.mainHook}>
            Start coding, start connecting, start now!
          </h1>
